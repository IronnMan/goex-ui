          ...
          >
            ...
            >
              <span
                ...
                aria-hidden="true"
              >
                <div v-if="!showDrawer" class="i-carbon-menu" />
          ...
          <slot name="title">
            ...
            >
              ...
              <span class="flex items-center">
                <div :class="app.logo" class="inline-block mr-2 text-lg text-primary-500" />
                {{ app.name }}
              </span>
            </NuxtLink>
          </slot>
          ...
          >
            ...
            >
              <span
                ...
                aria-hidden="true"
              >
                <div class="i-carbon-overflow-menu-vertical text-sm icon-btn" />
              </span>
            </button>
          </div>
        </div>
